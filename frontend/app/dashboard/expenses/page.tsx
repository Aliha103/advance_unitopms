    ...
    <div className="p-6">
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">
            Track operational costs, utilities, and supplier payments.
          </p>
        </div>
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-5">
        <div className="text-center py-12">
          ...
          <p className="text-sm font-medium text-gray-900 mb-1">No expenses recorded</p>
          <p className="text-xs text-gray-500">Track your property expenses to get accurate profitability reports.</p>
        </div>
      </div>
    </div>
  );
