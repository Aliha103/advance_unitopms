    ...
    <div className="p-6">
      ...
      <div className="mb-6">
        ...
        <p className="text-sm text-gray-500 mt-1">
          Configure automated message templates for guest communication.
        </p>
      </div>
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-8">
          <div className="text-center py-8">
            ...
            <p className="text-sm text-gray-500 max-w-md mx-auto mb-4">
              Create templated messages for booking confirmations, pre-arrival instructions, check-in reminders, review requests, and custom automated communications in multiple languages.
            </p>
